...
- Stable kotlin version : 2.0.0
- Kotlin can support java version 22
...
## Latest Kotlin Version Features
...
- In this case compiler understands that this is a single expression function, and return type will
...
- This may be helpful when a function has a large number of arguments, and it's difficult to associate a value with an argument,
