...
```
- Here **fetchAndShowUser()** is a suspend com.swasi.play.function where we do the network operation and after getting the result we delever the result in the main thread.
